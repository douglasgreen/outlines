...
* ajn - (suffix meaning "whatever", "ever")
* ajna - any
* akademia - academic
* akademika - academic
* akademio - academy
* akceli - to accelerate
* akcento - accent
...
* artisto - artist
* arto - art
* artoentuziasmulo - art enthusiast
* arĝenta - silver
* arĝento - silver
* arĥiduko - archduke
...
* atesto - attestation, certificate
...
* daŭri - to last
* daŭriga - continuing
* daŭrigante - continuing (participle form of "daŭrigi")
* daŭrigi - to continue
...
* diskurso - discourse
* diskutante - discussing (participle form of "diskuti")
* diskuti - to discuss
* diskuto - discussion
* disponi - to dispose, to have at one's disposal
* disputo - dispute
...
* disvolvadparadigmo - development paradigm
...
* ege - extremely
* ejo - place
* ek - prefix indicating the start of an action
* ekde - since
* ekesti - to arise
* eki - to start, begin
...
* engaĝiĝo - engagement, involvement
* enhavi - to contain
* enhavo - content
* enigi - to input
* enigo - input
...
* eĉ - even
* eĥante - echoing (participle form of "eĥi")
...
* flanke - on the side
* flanko - side, flank
* flapatante - flapping (participle form of "flapati")
* flari - to sniff
* flava - yellow
* fleksa - flexible
...
* impostkolekta - tax collecting (derived from "impostkolekti" - to collect taxes)
* imposto - tax
* impozi - to impose
* impregni - to impregnate, to soak
* ina - female
...
* kapitano - captain
* kapo - head
* kaptante - capturing (participle form of "kapti")
* kapti - to capture, to catch
...
* konsekvencisma - consequentialism
...
* kontroli - to control, to monitor
...
* leprulo - leper
* lernado - learning
* lernante - learning (participle form of "lerni")
...
* memori - to remember
* memorigante - reminding (participle form of "memorigi")
* memorigilo - reminder
* memoro - memory
...
* miksaĵo - mixture
* miksiĝante - mixing (participle form of "miksi")
* mil - thousand
* milda - mild
* milde - gently
* miliono - million
...
* movebleco - mobility
* movi - to move
* moviĝi - to move, to be in motion
* moviĝo - movement
* movo - movement
* mozaiko - mosaic
* multa - many, much
...
* ofte - often
* ok - eight
* okazaĵo - event, occurrence
* okaze - on the occasion of
* okazi - to occur, to happen
* okazo - occasion, opportunity
* okcidenta - western
...
* okulo - eye
* okupi - to occupy
* okupiĝi - to occupy oneself, to be engaged in
* ol - than
* oleo - oil
* omaĝe - in homage
* ombro - shadow
...
* pento - repentance
* pentrado - painting
* pentrante - painting (participle form of "pentri")
* pentraĵo - painting
* pentri - to paint
* pentristo - painter
* per - by, through
...
* plena - full
* plene - fully
* plenigante - filling (participle form of "plenigi")
* plenigi - to fill
...
* porko - pig
* portalo - portal
* portante - carrying (participle form of "porti")
* porti - to carry
* portreto - portrait
...
* premo - pressure
* prenado - taking
* prenante - taking (participle form of "preni")
* preni - to take
* preno - taking
...
* rakontante - telling (participle form of "rakonti")
...
* referi - to refer
* reflektante - reflecting
* reflekti - to reflect
* reformi - to reform
* reformo - reform
* regado - ruling, governance
* reganto - ruler, governor
...
* respondi - to answer, to respond
* respondo - response
* respublikana - republican
* respubliko - republic
* restaĵo - remainder, residue
...
* revante - dreaming (participle form of "revas")
...
* rezervo - reserve
* rezigni - to resign, to give up
* rezisti - to resist
* rezisto - resistance
* rezonado - reasoning
* rezulte - as a result
* rezulti - to result
* rezultigante - resulting
* rezulto - result
* reĝa - royal
* reĝimo - regime
* reĝino - queen
...
* salmo - psalm
* salo - salt
* saltante - jumping (participle form of "salti")
* salti - to jump
* saluti - to greet
* saluto - greeting
* sama - same
...
* senso - sense
* sentante - feeling (participle form of "senti")
* sentema - sensitive
* senti - to feel
* sento - feeling
* sep - seven
...
* traktante - treating, handling
* traktato - treaty
* trakti - to treat, to handle
* trakto - tract, treatise
* trankvile - peacefully
* trankvileco - tranquility
* trans - across, through
* transdoni - to transfer
...
* trovante - finding (participle form of "trovi")
* trovebli - findable
* trovi - to find
...
* turmenti - to torment
* turmento - torment
* turnante - turning (participle form of "turni")
* turni - to turn
...
* ĵazo - jazz
* ĵaŭdo - Thursday
* ĵetante - throwing (participle form of "ĵeti")
* ĵeti - to throw
...
* ŝanĝado - changing
* ŝanĝante - changing
* ŝanĝepoka - epoch-making, revolutionary
* ŝanĝi - to change
* ŝanĝiĝi - to change, to transform
* ŝanĝiĝo - change, transformation
* ŝanĝo - change
* ŝati - to like, to be fond of
* ŝi - she
* ŝia - her (possessive)
* ŝin - her (object)
* ŝipo - ship
